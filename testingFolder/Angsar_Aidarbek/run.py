...
def task2() -> str:
    """
    Perform a calculation: multiply 15 by 4 and add 20 to the result.
...
def task7(n: int) -> str:
    ...
    Example2: 13235 -> one2two1three1five1
...
def task16(a: int, b: int, c: int) -> str:
    """
...
def task18() -> str:
    ...
    I am greater than 5 but less than 10, and I am odd. What number am I?
